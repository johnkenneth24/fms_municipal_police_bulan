...
class CaseInvestController extends Controller
{
    public function index(Request $request)
    {
        ...
        $query = CrimeRecord::query()->with(['victim', 'suspect'])->where('case_status', 'Under Investigation')->orderBy('blotter_entry_no', 'asc');
        ...
        return view('modules.case-invest.index', compact('crime_records'));
    }}
