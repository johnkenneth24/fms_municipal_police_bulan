...
namespace App\Http\Livewire\CaseSolved;
...
class ExportCompilation extends Component
{
    ...
    public $path_export = 'docx/case_solved_compilation.docx';

    public function export()
    {
        $crimeRecords = CrimeRecord::where('case_status', 'Solved')
        ...
        $filename = 'Case Solved Compilation-' . now()->format('Y-m-d');
    ...
    {
        return view('livewire.case-solved.export-compilation');
    }
}
