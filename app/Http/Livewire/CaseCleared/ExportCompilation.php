...
namespace App\Http\Livewire\CaseCleared;
...
class ExportCompilation extends Component
{
    ...
    public $path_export = 'docx/case_cleared_compilation.docx';

    public function export()
    {
        $crimeRecords = CrimeRecord::where('case_status', 'Cleared')
        ...
        $filename = 'Case Cleared Compilation-' . now()->format('Y-m-d');
    ...
    {
        return view('livewire.case-cleared.export-compilation');
    }
}
