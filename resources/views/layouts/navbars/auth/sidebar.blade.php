...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3" id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
        ...
        <span class="ms-1 font-weight-bold text-logo" style="color: #ffffff; font-size: 15px;">FMS - Bulan MPS</span>
    </a>
  </div>
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link  {{ !request()->routeIs(['cs.*']) ?: 'active' }}" href="{{ route('cs.index') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="ni ni-check-bold ps-2 pe-2 text-center text-dark {{ !request()->routeIs(['cs.*']) ?:  'text-white' }}" aria-hidden="true"></i>
            </div>
      ...
      <li class="nav-item">
        <a class="nav-link  {{ !request()->routeIs(['cc.*']) ?: 'active' }}" href="{{ route('cc.index') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="ni ni-tag ps-2 pe-2 text-center text-dark {{ !request()->routeIs(['cc.*']) ?:  'text-white' }}" aria-hidden="true"></i>
            </div>
      ...
      <li class="nav-item">
        <a class="nav-link  {{ !request()->routeIs(['ci.*']) ?: 'active' }}" href="{{ route('ci.index') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="ni ni-badge ps-2 pe-2 text-center text-dark {{ !request()->routeIs(['ci.*']) ?:  'text-white' }}" aria-hidden="true"></i>
            </div>
      ...
      <li class="nav-item">
        <a class="nav-link  {{ !request()->routeIs(['s.*']) ?: 'active' }}" href="{{ route('s.index') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="fa fa-id-badge ps-2 pe-2 text-center text-dark {{ !request()->routeIs(['s.*']) ?:  'text-white' }}" aria-hidden="true"></i>
            </div>
      ...
      <li class="nav-item">
        <a class="nav-link  {{ !request()->routeIs(['v.*']) ?: 'active' }}" href="{{ route('v.index') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="fa fa-user ps-2 pe-2 text-center text-dark {{ !request()->routeIs(['v.*']) ?:  'text-white' }}" aria-hidden="true"></i>
            </div>
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ !request()->routeIs(['cg.*']) ?: 'active' }}" href="{{ route('cg.index') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <i style="font-size: 1rem;" class="fa fa-bar-chart fa-list-ul ps-2 pe-2 text-center text-dark {{ !request()->routeIs(['cg.*']) ?:  'text-white' }}" aria-hidden="true"></i>
            </div>
