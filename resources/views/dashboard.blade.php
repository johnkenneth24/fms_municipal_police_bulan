    ...
    <div class="row mt-4">
                        ...
                        <div class="col-lg-5 ms-auto text-center mt-5 mt-lg-0">
                            <div class="bg-gradient-info border-radius-lg h-100">
                                ...
                                <div class="position-relative d-flex align-items-center justify-content-center h-100">
                                    <img class="w-70 position-relative z-index-2 pt-4" src="../assets/img/illustrations/police.png" alt="rocket">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-lg-5">
            <div class="card h-100 p-3">
                <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100" style="background-image: url('../assets/img/pnpit.jpg');">
