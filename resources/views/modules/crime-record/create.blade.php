                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="incident_location"
                                        required placeholder="Specify location where incident occurred">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="s_firstname"
                                        ...
                                        value="{{ old('s_firstname') }}" required placeholder="Enter First Name">
                                    @error('s_firstname')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="s_lastname"
                                        ...
                                        value="{{ old('s_lastname') }}" required placeholder="Enter Last Name">
                                    @error('s_lastname')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control form-control-sm s_bdate" name="s_birthdate"
                                        required value="{{ old('s_birthdate') }}">
                                </div>
                            </div>
                            <div class="col-md-1">
                                <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="s_birthplace"
                                        required value="{{ old('s_birthplace') }}" placeholder="Enter Birthplace">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
