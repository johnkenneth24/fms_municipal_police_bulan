                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="blotter_entry_no" value="{{ $latestBlotterNo }}" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="v_firstname" class="form-control form-control-sm @error('v_firstname') is-invalid @enderror" value="{{ old('v_firstname') }}" required placeholder="Enter First Name">
                                @error('v_firstname')
                        ...
                        <div class="col-md-1">
                            <div class="form-group">
                                <label>Age</label>
                                <input type="number" name="v_age" class="form-control form-control-sm text-end v_age" readonly required placeholder="0">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Birthplace <span class="text-danger">*</span> </label>
                                <input type="text" class="form-control form-control-sm" name="v_birthplace" required value="{{ old('v_birthplace') }}" placeholder="Enter Birthplace">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" name="v_occupation" value="{{ old('v_occupation') }}" placeholder="Enter Occupation">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
