                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input readonly  type="text" class="form-control form-control-sm" name="blotter_entry_no"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input readonly  type="date" class="form-control form-control-sm" name="date_committed"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input readonly  type="time" class="form-control form-control-sm" name="time_committed"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input readonly  type="date" class="form-control form-control-sm" name="date_reported"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input readonly  type="time" class="form-control form-control-sm" name="time_reported"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select disabled  class="form-control form-control-sm" name="incident_location"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea readonly  class="form-control form-control-sm" required name="incident_details" rows="2"
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input readonly  type="text" name="v_firstname"
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input readonly  type="text" name="v_middlename" class="form-control form-control-sm"
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input readonly  type="text" name="v_lastname"
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input readonly  type="date" class="form-control form-control-sm v_bdate" name="v_birthdate"
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    <label>Age</label>
                                    <input readonly  type="number" name="v_age" value="{{ $v_age }}"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input readonly  type="text" class="form-control form-control-sm" name="v_birthplace"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input readonly  type="text" class="form-control form-control-sm" name="v_occupation"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input readonly  type="text" class="form-control form-control-sm" name="v_education"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input readonly  type="text" class="form-control form-control-sm" name="v_address"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input readonly  type="text" class="form-control form-control-sm" name="v_contact_number"
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input readonly  type="text" class="form-control form-control-sm" name="v_citizenship"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group d-flex justify-content-center">
                                                <label class="radio-inline text-muted me-2">
                                                    <input readonly  type="radio" name="is_ethnic_member" value="yes" checked
                                                        id="ethnicYes" class="form-radio">
                                                    Yes
                                                </label>
                                                <label class="radio-inline text-muted">
                                                    <input readonly  type="radio" name="is_ethnic_member" value="no"
                    ...
                    <div class="card-body pt-0">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>First Name <span class="text-danger">*</span> </label>
                                    <input readonly  type="text" name="s_firstname"
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Middle Name</label>
                                    <input readonly  type="text" name="s_middlename" class="form-control form-control-sm"
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Last Name <span class="text-danger">*</span> </label>
                                    <input readonly  type="text" name="s_lastname"
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Birthdate <span class="text-danger">*</span> </label>
                                    <input readonly  type="date" class="form-control form-control-sm s_bdate" name="s_birthdate"
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    <label>Age</label>
                                    <input readonly  type="number" name="s_age" value="{{ $s_age }}"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Birthplace <span class="text-danger">*</span> </label>
                                    <input readonly  type="text" class="form-control form-control-sm" name="s_birthplace"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Occupation</label>
                                    <input readonly  type="text" class="form-control form-control-sm" name="s_occupation"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Educational Attainment</label>
                                    <input readonly  type="text" class="form-control form-control-sm" name="s_education"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Address <span class="text-danger">*</span> </label>
                                    <input readonly  type="text" class="form-control form-control-sm" name="s_address"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Contact Number</label>
                                    <input readonly  type="text" class="form-control form-control-sm" name="s_contact_number"
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Nationality <span class="text-danger">*</span> </label>
                                    <input readonly  type="text" class="form-control form-control-sm" name="s_citizenship"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input readonly  type="text" class="form-control form-control-sm" name="relation_to_victim"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea readonly  class="form-control form-control-sm" name="suspect_motive" value="" rows="2"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input readonly  type="text" class="form-control form-control-sm" name="investigator"
