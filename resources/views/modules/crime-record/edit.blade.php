                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="blotter_entry_no" value="{{ $crime_record->blotter_entry_no }}" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control form-control-sm" name="date_committed" required value="{{ $crime_record->date_committed->format('Y-m-d') }}">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Time Commited</label>
                                <input type="time" class="form-control form-control-sm" name="time_committed" required value="{{ $crime_record->time_committed }}">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Date Reported</label>
                                <input type="date" class="form-control form-control-sm" name="date_reported" value="{{ $crime_record->date_reported->format('Y-m-d') }}">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Time Reported</label>
                                <input type="time" class="form-control form-control-sm" name="time_reported" value="{{ $crime_record->time_reported ?? date ('H:i') }}">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control form-control-sm" required name="incident_details" rows="2" placeholder="Type here...">{{ $crime_record->incident_details }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="v_firstname" class="form-control form-control-sm @error('v_firstname') is-invalid @enderror" value="{{ $crime_record->victim->firstname }}" required placeholder="Enter First Name">
                                @error('v_firstname')
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="v_middlename" class="form-control form-control-sm" value="{{ $crime_record->victim->middlename }}" placeholder="Enter Middle Name">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>Last Name <span class="text-danger">*</span> </label>
                                <input type="text" name="v_lastname" class="form-control form-control-sm @error('v_lastname') is-invalid @enderror" value="{{ $crime_record->victim->lastname }}" required placeholder="Enter Last Name">
                                @error('v_lastname')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-md-1">
                            <div class="form-group">
                                <label>Age</label>
                                <input type="number" name="v_age" value="{{ $v_age }}" class="form-control form-control-sm text-end v_age" required placeholder="0">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Birthplace <span class="text-danger">*</span> </label>
                                <input type="text" class="form-control form-control-sm" name="v_birthplace" required value="{{ $crime_record->victim->birthplace }}" placeholder="Enter Birthplace">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" name="v_occupation" value="{{ $crime_record->victim->occupation }}" placeholder="Enter Occupation">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Educational Attainment</label>
                                <input type="text" class="form-control form-control-sm" name="v_education" value="{{ $crime_record->victim->education }}" placeholder="Enter Educational Attainment">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Address <span class="text-danger">*</span> </label>
                                <input type="text" class="form-control form-control-sm" name="v_address" value="{{ $crime_record->victim->address }}" placeholder="(House No., Street Name, Barangay, Municipality, Province)">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Contact Number</label>
                                <input type="text" class="form-control form-control-sm" name="v_contact_number" value="{{ $crime_record->victim->contact_number }}" placeholder="Enter Contact No.">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>Nationality <span class="text-danger">*</span> </label>
                                <input type="text" class="form-control form-control-sm" name="v_citizenship" value="{{ $crime_record->victim->citizenship }}" placeholder="Enter Nationality">
                            </div>
                        </div>
                ...
                <div class="card-body pt-0">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>First Name <span class="text-danger">*</span> </label>
                                <input type="text" name="s_firstname" class="form-control form-control-sm @error('s_firstname') is-invalid @enderror" value="{{ $crime_record->suspect->firstname }}" required placeholder="Enter First Name">
                                @error('s_firstname')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>Middle Name</label>
                                <input type="text" name="s_middlename" class="form-control form-control-sm" value="{{ $crime_record->suspect->middlename }}" placeholder="Enter Middle Name">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>Last Name <span class="text-danger">*</span> </label>
                                <input type="text" name="s_lastname" class="form-control form-control-sm @error('s_lastname') is-invalid @enderror" value="{{ $crime_record->suspect->lastname }}" required placeholder="Enter Last Name">
                                @error('s_lastname')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>Birthdate <span class="text-danger">*</span> </label>
                                <input type="date" class="form-control form-control-sm s_bdate" name="s_birthdate" required value="{{ $crime_record->suspect->birthdate }}">
                            </div>
                        </div>
                        <div class="col-md-1">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Birthplace <span class="text-danger">*</span> </label>
                                <input type="text" class="form-control form-control-sm" name="s_birthplace" required value="{{ $crime_record->suspect->birthplace }}" placeholder="Enter Birthplace">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Occupation</label>
                                <input type="text" class="form-control form-control-sm" name="s_occupation" value="{{ $crime_record->suspect->occupation }}" placeholder="Enter Occupation">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Educational Attainment</label>
                                <input type="text" class="form-control form-control-sm" name="s_education" value="{{ $crime_record->suspect->education }}" placeholder="Enter Educational Attainment">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Address <span class="text-danger">*</span> </label>
                                <input type="text" class="form-control form-control-sm" name="s_address" value="{{ $crime_record->suspect->address }}" placeholder="(House No., Street Name, Barangay, Municipality, Province)">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Contact Number</label>
                                <input type="text" class="form-control form-control-sm" name="s_contact_number" value="{{ $crime_record->suspect->contact_number }}" placeholder="Enter Contact No.">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>Nationality <span class="text-danger">*</span> </label>
                                <input type="text" class="form-control form-control-sm" name="s_citizenship" value="{{ $crime_record->suspect->citizenship }}" placeholder="Enter Nationality">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Relation to Victim</label>
                                <input type="text" class="form-control form-control-sm" name="relation_to_victim" value="{{ $crime_record->suspect->relation_to_victim }}" placeholder="Enter Relation to Victim">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-sm" name="used_weapon">
                                    ...
                                    <option value="{{ $weapons }}" @selected($crime_record->suspect->weapon_use==$weapons)>
                                        {{ $weapons }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control form-control-sm" name="suspect_motive" value="" rows="2" placeholder="Type here...">{{ $crime_record->suspect->suspect_motive }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" name="investigator" value="{{ $crime_record->investigator }}" placeholder="Name of Investigator in charge of the case">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
